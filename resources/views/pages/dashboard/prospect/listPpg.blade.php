                                ...
                                @forelse ($listPpg as $lppg)
                                    <tr class="text-gray-700 border-b">
                                        ...
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->user->name ?? '' }}
                                                    </p>
                                                    <p class="text-sm text-gray-400">
                                                        {{ $lppg->user->occupation ?? '' }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->wali->name ?? '' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->prospect->name ?? '' }}
                                                    </p>
                                                    <p class="text-sm text-gray-400">
                                                        {{ $lppg->created_at ?? '' }}</p>
                                                </div>
                                        ...
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->prospect->school ?? '' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->prospect->phone ?? '' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-medium text-black">{{ $lppg->route ?? '' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-1 py-5 text-sm w-2/8">
                                            <a href="{{ route('admin.prospect.show', $lppg->id) }}"
